...
const stats = [
  { value:11,  suffix:'+', label:'Années d\'Expérience', icon:<Award size={26} color="white"/> },
...
const whyUs = [
  { icon:<Award size={30} color="#E8600A"/>,        title:'Expertise Certifiée',    desc:'Plus de 11 ans d\'expérience dans l\'ingénierie industrielle et la sécurité électronique au Sénégal.' },
        ...
        <div style={{maxWidth:'1280px',margin:'0 auto',padding:'140px 24px 100px',position:'relative',zIndex:1,width:'100%'}}>
          <div style={{maxWidth:'700px'}}>
            ...
            <p style={{fontFamily:'Rajdhani, sans-serif',fontSize:'clamp(15px,2vw,18px)',color:'rgba(255,255,255,0.8)',lineHeight:1.75,maxWidth:'520px',marginBottom:'44px',letterSpacing:'0.03em'}}>
              Leader en instrumentation industrielle, télésurveillance et sécurité incendie au Sénégal. Solutions technologiques au niveau national et international.
            </p>
