            ...
            <FadeIn direction="left">
              <div>
                ...
                <p style={{fontFamily:'Rajdhani, sans-serif',fontSize:'15px',color:'#555',lineHeight:1.8,marginBottom:'18px'}}>
                  Dabakh Global Services SARL est une société sénégalaise spécialisée dans l&apos;ingénierie industrielle, la télésurveillance, la sécurité incendie et l&apos;instrumentation. Fondée avec la vision d&apos;apporter des solutions technologiques de niveau international à l&apos;Afrique de l&apos;Ouest.
                </p>
